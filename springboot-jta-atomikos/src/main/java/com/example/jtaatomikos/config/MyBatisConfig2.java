package com.example.jtaatomikos.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "com.example.jtaatomikos.datasource2",sqlSessionTemplateRef = "sqlSessionTemplate2")
public class MyBatisConfig2 {
    /**
     *  配置数据源
     */
    @Bean(name = "dataSource2")
    public DataSource testDataSource(DataSourceConfiguration2 testConfig) throws SQLException {
